...
- [x] **SummaryBar viewCount**: Wireframe 4.3 "조회수" 항목 추가 (`SummaryBar.tsx`) — 완료 (c0f102a)
- [x] **SummaryBar 기간**: Wireframe 4.3 "기간" 시작~종료 표시 (`SummaryBar.tsx`) — 완료 (c0f102a)
- [x] **홈 랭킹 프리뷰**: Wireframe 4.1 Rankings Preview 섹션 (`page.tsx`) — 완료 (c0f102a)
- [x] **홈 운영 품질 증거**: Wireframe 4.1 SSOT/PRD/Schema/Workflow + 자동화 프로세스 카드 (`page.tsx`) — 완료 (c0f102a)
- [x] **Camp 모집 마감**: Handover "지원 기능: 모집 마감 처리" — isOpen 토글 (`camp/page.tsx`, `TeamCard.tsx`) — 완료 (c0f102a)
- [x] **Camp 팀 수정**: Handover "지원 기능: 수정" — 기존 값 채워 수정 (`camp/page.tsx`, `TeamCard.tsx`) — 완료 (c0f102a)
